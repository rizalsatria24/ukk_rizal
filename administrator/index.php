...
?>
       	...
       	<a href="data_barang.php"  class="btn btn-dark">Detail</a>
             </div>
       	</div>
       	</div>
       	<div class="col-sm-4">
       	...
       	<div class="card-body">
               ...
               <a href="pembelian.php"  class="btn btn-dark">Detail</a>
       		</div>
       	</div>
	</div>
       	<div class="col-sm-4">
             ...
             <a href="data_pengguna.php"  class="btn btn-dark">Detail</a>
            ...
            <div class="card mt-2">
            	<div class="card-body">
            		...
            		silahkan bisa mengakses beberapa fitur</p>
            	</div>
            </div>
