      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <a class="btn btn-primary" href="detail_pembelian.php?PelangganID=<?php echo $d['PelangganID']; ?>">Pembelian</a>
...
<form method="post" action="proses_hapus_pembelian.php" >
      <div class="modal-body">
        ...
        Apakah Kalian Yakin Akan Menghapus Data Produk <b><?php echo $d['NamaPelanggan']; ?></b>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
